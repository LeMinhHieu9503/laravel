                    ...
                    <div class=" space-y-5">
                        <div class="card">
                            <header class=" card-header noborder">
                                <h4 class="card-title">Quản Lí Bình luận
                                </h4>
                            </header>
                                            ...
                                            <table
                                                ...
                                                @foreach($data as $key=>$value)
                                                    <tr id="record-{{$value->id}}">
                                                        ...
                                                        <td class="table-td ">{{ $value->products->first()->categories->first()->name }}</td>
                                                        <td class="table-td ">{{ $value->users->first()->name }}</td>
                                                        <td class="table-td ">{{ $value->products->first()->name }}</td>
                                                        <td class="table-td ">{{ $value->content }}</td>
                                                        <td class="table-td ">
