        ...
        <div class="container-fluid">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="index.html"><img class="main__logo--img" src="{{ asset('client/assets/img/logo/nav-log.png') }}" alt="logo-img"></a></h1>
                </div>
                    ...
                    <ul class="d-flex">
                        <li class="header__account--items">
                            @auth
                                ...
                                <span class="header__account--btn d-flex flex-column align-items-center">
    ...
    <div class="header__bottom">
        <div class="container-fluid">
            <div class="header__bottom--inner position__relative d-none d-lg-flex justify-content-between align-items-center">
                ...
                <p class="header__discount--text"><img class="header__discount--icon__img" src="{{ asset('client/assets/img/icon/lamp.png') }}" alt="lamp-img"> Special up to 60% Off all item</p>
            </div>
        </div>
    </div>
        ...
        <div class="offcanvas__inner">
            <div class="offcanvas__logo">
                <a class="offcanvas__logo_link" href="index.html">
                    <img src="{{ asset('client/assets/img/logo/nav-log.png') }}" alt="Grocee Logo" width="158" height="36">
                </a>
                    ...
                    <ul class="d-flex align-items-center">
                        <li class="language__currency--list">
                            <a class="offcanvas__language--switcher" href="#">
                                <img class="language__switcher--icon__img" src="{{ asset('client/assets/img/icon/language-icon.png') }}" alt="currency">
                                <span>English</span>
                        ...
                        <li class="language__currency--list">
                            <a class="offcanvas__account--currency__menu" href="#">
                                <img src="{{ asset('client/assets/img/icon/usd-icon.png') }}" alt="currency">
                                <span>$ US Dollar</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="11.797" height="9.05" viewBox="0 0 9.797 6.05">
                                    <path  d="M14.646,8.59,10.9,12.329,7.151,8.59,6,9.741l4.9,4.9,4.9-4.9Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                </svg>
